...
const Dashboard = () => {
  const [countriesData, setCountriesData] = useState([]); // State to hold countries' COVID-19 data
  const [chartData, setChartData] = useState({}); // State to hold chart data for COVID-19 cases
