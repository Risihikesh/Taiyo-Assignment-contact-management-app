...
function EditContact() {
    ...
    const AllContact = useSelector((store) => store.contacts); // Get all contacts from the Redux store

    const [form, setForm] = useState({}); // State to manage form fields for editing
    ...
    useEffect(() => {
        ...
        // Fetch the contact information based on the provided id from Redux store
